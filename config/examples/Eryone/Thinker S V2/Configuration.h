...
#define CONFIG_EXAMPLES_DIR "Eryone/Thinker S V2"
...
#define STRING_CONFIG_H_AUTHOR "(Alex Mi, BLTouch)" // Who made the changes.
...
// Name displayed in the LCD "Ready" message and Info menu
  ...
  #define CUSTOM_MACHINE_NAME "Thinker SV2+"
#else
  #define CUSTOM_MACHINE_NAME "Thinker SV2"
#endif
